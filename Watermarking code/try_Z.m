...
while chos~=possibility,
    chos=menu('Digital 3-level image watermarking','select the cover image','select the watermark image','show watermarked image','show extracted image','Calculate MSE for embedding');
    if chos==1
